...
def savebill():
    global billnumber
   # length=int(entryContact.get())
    #if len(length)==10:
     #   messagebox.showerror('invalid error','null number')
...
def total():
    ...
    cosmeticPriceEntry.insert(0, str(totalCosmeticprice) + 'KSH')
    cosmetictax = totalCosmeticprice * 0.02
    cosmeticTaxEntry.delete(0, END)
    cosmeticTaxEntry.insert(0, str(cosmetictax) + 'KSH')
    ...
    groceryPriceEntry.insert(0, str(totalGroceryprice) + 'KSH')
    grocerytax = totalGroceryprice * 0.03
    groceryTaxEntry.delete(0, END)
    groceryTaxEntry.insert(0, str(grocerytax) + 'KSH')
    ...
    drinksPriceEntry.insert(0, str(totalDrinksprice) + 'KSH')
    drinkstax = totalDrinksprice * 0.19
    drinksTaxEntry.delete(0, END)
    drinksTaxEntry.insert(0, str(drinkstax) + 'KSH')
...
def emails():
    ...
    if textArea.get(1.0, END) == '\n':
        ...
        # message
        messagelabel = Label(reciepientFrame, text='  reciept ', font=('arial', 14, 'bold'), bd=6,
                             fg='white', bg='blue')
        ...
        sendButton = Button(wn, text='send', font=('arial', 15, 'bold'), width=13,command=send_gmail)
        sendButton.grid(row=2, column=1, pady=10)
...
cosmeticFrame = LabelFrame(productFrame, text='BEAUTY AND COSMETICS  ', font=('arial', 13, 'bold'),
...
groceryFrame = LabelFrame(productFrame, text='FOODINGS  ', font=('arial', 13, 'bold'),
                          fg='gold', bd=8, relief=GROOVE, bg='green')
...
drinksFrame = LabelFrame(productFrame, text='SAMPLE DRINKS  ', font=('arial', 13, 'bold'),
                         fg='gold', bd=8, relief=GROOVE, bg='green')
...
billAreaLabel = Label(billFrame, text='BILL CALCULATION SECTION ', font=('times new roman', 13, 'bold'),
                      bd=8, relief=GROOVE,bg='blue',fg='white')
...
textArea = Text(billFrame, width=55, height=20, yscrollcommand=scrollbar.set,font=('arial', 7, 'bold'))
...
groceryPriceLabel = Label(billMenuFrame, text=' FOODINGS price ', font=('times new roman', 13, 'bold',
                                                                       ), bg='green', fg='white')
...
groceryTaxLabel = Label(billMenuFrame, text=' FOODINGS Tax ', font=('times new roman', 13, 'bold',
                                                                   ), bg='green', fg='white')
